          ...
          <div class="row">
            <div class="col-xl-3 g-2 col-centered">
              ...
              <div class="row p-1">
                ...
                <p class="p-1 border bg-light" style="height:228px; width:228px; margin-top:34px; margin-left:20px;" id="surroundImage">
            ...
            <div class="col-xl">
              ...
              <div class="row g-2">
                ...
                <div class="col-lg-3 border bg-light" style="font-size: 92%; max-height: 58px; border-radius: 5px;">
                  ...
                  <span style="margin-left:10px">Birth Date:</span>
                  <div class="row-auto">
              ...
              <div class="row g-2">
                <div class="col-lg input-group" style="height: 58px">
                  ...
                  {{Form::number('contactNum1', '', ['class' => 'form-control', 'placeholder' => 'Primary Contact #','aria-describedby' => 'countryCode', 'style' => 'font-size: 18px','maxlength' => '10', 'required'])}}
                ...
                <div class="col-lg input-group" style="height: 58px">
                  ...
                  <span class="input-group-text">+63</span>
                  {{Form::number('contactNum2', NULL, ['class' => 'form-control', 'placeholder' => 'Secondary Contact # (Optional)','aria-describedby' => 'countryCode', 'style' => 'font-size: 18px', 'maxlength' => '10'])}}
              ...
              <div class="row g-2" style="margin-bottom: 8px; margin-top: 10px">
                ...
                <div class="col-lg input-group" style="height: 58px">
                  ...
                  <span class="input-group-text">+63</span>
                  {{Form::number('emergencyContactNum', '', ['class' => 'form-control', 'placeholder' => 'Emergency Contact #','aria-describedby' => 'countryCode', 'style' => 'font-size: 18px','maxlength' => '10'])}}
          ...
          <div class="row">
            ...
            <div class="col-lg-10">
                ...
                <div class="row g-2">
                  ...
                  <div class="col-lg-4 border bg-light" style="font-size: 92%; max-height: 58px; border-radius: 5px; max-width: 95%; margin-left:3px;">
            ...
            <div class="col-lg-10">
                ...
                <div class="row g-2">
                  ...
                  <div class="col-xl-4 form-floating">
                    ...
                    {{Form::number('current_rate', '', ['class' => 'form-control filled', 'placeholder' => 'Current Rate', 'id' => 'floatingFirst','required'])}}
                    <label for="floatingFirst">Current Rate</label>
                  </div>
